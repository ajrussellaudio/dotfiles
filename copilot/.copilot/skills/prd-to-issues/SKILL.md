...
Read the issue's labels and find the one starting with `prd/` (e.g. `prd/foo-widget`). This is the **feature label** — you will apply it to every task issue you create.
