...
For detailed security guidance, see [`references/security-checklist.md`](references/security-checklist.md). Does the change introduce vulnerabilities?
...
For detailed profiling and optimization, see [`references/performance-checklist.md`](references/performance-checklist.md). Does the change introduce performance problems?
...
For triaging `npm audit` findings and supply-chain risk (typosquatting, compromised maintainers), see [Dependency Security](references/security-checklist.md) — this section covers the upgrade *workflow*, that one covers the security verdict.
